...
- **Saída de skills anteriores na mesma execução** — ex.: `extract_requirements` alimenta `identify_actor`/`identify_goal`/`identify_business_rules`/`identify_dependencies`, que alimentam `generate_story`.
